...
class M3AS:
    ...
    def initialize_pheromone_matrix(self):
        # Initialize pheromone trails with a high exploration value
    ...
    def calculate_probabilities(self, current_node, unvisited_nodes):
        # Calculate probabilities for unvisited nodes based on pheromone and heuristic information
...
# Obtain the final pheromone matrix after iterations
final_pheromone_matrix = m3as_solver.tau
